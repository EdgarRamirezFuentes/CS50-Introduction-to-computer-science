/**
 * Evaluate wether the value is empty or not. If the value is empty, returns true
...
/**
 * Evaluate that the username is valid by checking that it is not an empty string and
...
/**
 * Evaluate that the password is valid by checking that it is not an empty string and
 * checking that matches the established pattern. If any of these requirements is not fulfilled
 * a message will be shown in the message container and will return false;
...
/**
 * Evaluate that the password and its confirmation password match. If these two do not match,
 * a message will be shown in the message container and will return false;
